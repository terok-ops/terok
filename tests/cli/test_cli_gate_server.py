...
class TestCmdInstall(unittest.TestCase):
    ...
    def test_install(self, mock_install: unittest.mock.Mock) -> None:
...
class TestCmdUninstall(unittest.TestCase):
    ...
    def test_uninstall(self, mock_uninstall: unittest.mock.Mock) -> None:
        with unittest.mock.patch("sys.stdout", new_callable=StringIO) as out:
            _cmd_uninstall()
...
class TestCmdStart(unittest.TestCase):
    ...
    def test_start(self, _mock_running: unittest.mock.Mock, mock_start: unittest.mock.Mock) -> None:
        with unittest.mock.patch("sys.stdout", new_callable=StringIO) as out:
